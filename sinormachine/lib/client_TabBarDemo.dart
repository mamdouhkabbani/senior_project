...
import 'package:sinormachine/testImage.dart';
...
class client_TabBarDemo extends StatefulWidget {
  client_TabBarDemo({Key key}) : super(key: key);
  @override
  _MyTabBarDemo createState() => _MyTabBarDemo();
}
class _MyTabBarDemo extends State<client_TabBarDemo> {
  @override
  void initState() {
    super.initState();
  }
