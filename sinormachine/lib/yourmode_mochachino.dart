...
class yourmode_mochachino extends StatefulWidget
{
  const yourmode_mochachino({Key key}) : super(key: key);
  @override
...
class _MyStatefulWidgetState extends State<yourmode_mochachino>
{
  double cohco = 1;
  double water = 1;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Column(children: <Widget>[
        Text("Special Taste Mochachino",
            style: TextStyle(
                color: Colors.black,
                fontWeight: FontWeight.bold,
                fontSize: 20)),
        Text("Ordinary Cup Contain Cohco:1= 6 Grams ,Three_in_one:1= 6 Grams ,Water:1=200 Ml",
            style: TextStyle(
                color: Colors.red,
                fontWeight: FontWeight.bold,
                fontSize: 20)),
        ...
        Center(child:Row(children: <Widget>[
          Container(child:Text("cohco",style:TextStyle(color: Colors.black,fontWeight:FontWeight.bold)),padding:EdgeInsets.fromLTRB(50, 0, 0, 10),),
        ...
        Center(child:Row(children: <Widget>[
          Container(child:Text("three_in_one",style:TextStyle(color: Colors.black,fontWeight:FontWeight.bold)),padding:EdgeInsets.fromLTRB(10, 10, 0, 0),),
        ...
        Container(height: 100,width: 200,),
        Center(child:Row(children: <Widget>[
          Container(child:Text("water",style:TextStyle(color: Colors.black,fontWeight:FontWeight.bold)),padding:EdgeInsets.fromLTRB(45, 10, 0, 0),),
              ...
              Expanded(
                  child: RaisedButton(
                    onPressed: () async {
                      ...
                      add_to_total=rotation_rate_three_in_one+rotation_rate_cohco+rotation_rate_water;
                      print(add_to_total);
