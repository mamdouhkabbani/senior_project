...
class Charge_Clien_Account extends StatefulWidget{
  const Charge_Clien_Account({Key key}) : super(key: key);
  @override
...
class _MyStatefulWidgetState extends State<Charge_Clien_Account> {
  ...
  Future getData1() async{
    Uri url=Uri.parse("https://alumaracoffe.com/employee/Viwe_All_Client_Activate.php");
  ...
  Future  getpostname() async{
    Uri url=Uri.parse("https://alumaracoffe.com/employee/search_by-email_Client.php");
  ...
  Future  getpostid() async{
    Uri url=Uri.parse("https://alumaracoffe.com/employee/search_by_id_Client.php");
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text("Client Charge Account")
      ),
      drawer: MyDrawer(),
      body: Column(
        children: <Widget>[
                ...
                if (snapshot.hasData) {
                  return ListView.builder(
                    ...
                    itemBuilder: (context , i){
                      return Test_Charge_Client_Account(id: snapshot.data[i]['id'],
