...
class Final_Transfare_To_Store extends StatefulWidget {
  const Final_Transfare_To_Store({Key key}) : super(key: key);
...
class _MyPermision extends State<Final_Transfare_To_Store> {
  ...
  Future Charge() async  {
    Uri url = Uri.parse("https://alumaracoffe.com/employee/Charge_Store.php");
...
/*  Future changepermision() async {
  ...
  Widget build(BuildContext context) {
    ...
    return Directionality(
      ...
      child: Scaffold(
        appBar: AppBar(title: Text("Charge Store")),
        drawer: MyDrawer(),
        body: Column(
          children: <Widget>[
            Text(Name,
