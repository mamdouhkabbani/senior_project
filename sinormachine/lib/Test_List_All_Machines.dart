...
class Test_List_All_Machines extends StatelessWidget {
  //var price ;
  //var id;
var name;
  var id;
            ...
            onTap:() async{
              if(avalabiles){
               /* await Navigator.pushNamed(context,'MachineDetails',
                ...
                Navigator.push (
                  context,
                  CupertinoPageRoute(builder: (context) =>  Machine_Details(
                    id: id,
                    first_name: first_name,last_name: last_name,three_in_one: three_in_one,Choco: Choco,coffe: coffe,temp: temp,water: water,location: location,
